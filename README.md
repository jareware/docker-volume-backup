...
`CHECK_HOST` |  | When provided, the availability of the named host will checked. If the host answers a ping, the backup if conducted as normal. Else, the backup is skipped.
