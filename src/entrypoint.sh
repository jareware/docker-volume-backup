...
ROTATE_HOURLY="${ROTATE_HOURLY:--1}"
ROTATE_DAILY="${ROTATE_DAILY:-7}"
ROTATE_WEEKLY="${ROTATE_WEEKLY:-4}"
ROTATE_MONTHLY="${ROTATE_MONTHLY:-12}"
ROTATE_YEARLY="${ROTATE_YEARLY:-always}"
